...
# Aplicativo Leitor RFID (Projeto Smart Stock)
...
1.  **Clone o repositório:**
    ...
    ```bash
    git clone {repositório do smartstock-mobile}
...
5.  **Gere os arquivos de rota:**
    O projeto utiliza `auto_route` para navegação. Durante o desenvolvimento, execute o seguinte comando para gerar os arquivos necessários:
...
- Comando útil: flutter build apk --ofuscate --split-debug-info=/output
...
Esse repositório contém a implementação do aplicativo móvel do projeto, desenvolvido por **[Ruan Macedo Santos](https://github.com/msruan)**.
