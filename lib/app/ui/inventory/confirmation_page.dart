...
import 'package:smart_stock/app/ui/_mutations/init_inventory_mutation.dart';
...
@RoutePage()
class InventoryConfirmationPage extends ConsumerWidget {
        ...
        children: [
          ...
          stockState.when(
            data: (_) => _StatusItem(
              ...
              isFresh: stockLastUpdate != null ? isStockFresh(stockLastUpdate) : true,
            ),
