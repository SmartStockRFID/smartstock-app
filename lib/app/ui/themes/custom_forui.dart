// lib/app/ui/themes/custom_forui.dart

import 'package:flutter/material.dart';
import 'package:forui/forui.dart';

/// Retorna a "receita" para um botão com aparência desabilitada.
///
/// Esta é uma função top-level simples para garantir que o Dart a encontre
/// sem problemas de resolução de extensões.
///
/// Usa o [context] para obter o tema atual da `forui` e construir o estilo.
